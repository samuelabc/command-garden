...
describe('executeDaemonStart', () => {
  ...
  it('spawns daemon process and waits for ready', async () => {
    ...
    const result = await executeDaemonStart('http://127.0.0.1:9091', '/fake/home/.commandgarden', '/fake/daemon/main.js', 'node');
  ...
  it('reports unresponsive on timeout without crash', async () => {
    ...
    const resultPromise = executeDaemonStart('http://127.0.0.1:9091', '/fake/home/.commandgarden', '/fake/daemon/main.js', 'node');
