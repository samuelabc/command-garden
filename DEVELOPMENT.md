# commandGarden — Developer & Technical Guide

> Looking for the quick overview and install instructions? See the [README](README.md). This document is the full technical reference for developers and contributors.
